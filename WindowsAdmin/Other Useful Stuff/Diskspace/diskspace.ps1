$users = "sysadmin@jbssa.com.au" # List of users to email your report to (separate by comma)
$fromemail = "sysadmin@jbssa.com.au"
$server = "mail.amh.com.au" #enter your own SMTP server DNS name / IP address here
...
<u><b>Exchange disk space report</b></u>
<br>This report was generated because the Exchnage server disk(s) listed below have less than $thresholdspace % free space. Disks above this threshold will not be listed.
<br><br>
...
if ($regex.IsMatch($regexsubject)) {
				send-mailmessage -from $fromemail -to $users -subject "Exchange disk space low!" -BodyAsHTML -body $HTMLmessage -priority High -smtpServer $server
}
