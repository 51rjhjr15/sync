...
Send-MailMessage -From "MYCA@xyz.com" -To "me@xyz.com" -Subject "Certificates soon to Expire!" -Body ($CertToList | out-string) -Priority High -SMTPserver "mail.xyz.com" -DeliveryNotificationOption onFailure